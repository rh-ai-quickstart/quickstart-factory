...
```bash
python3 core/skills/gh-backlog-reader/scripts/read_backlog.py [options]
```
...
# Filter by label
python3 core/skills/gh-backlog-reader/scripts/read_backlog.py --label quickstart_suggestion
...
python3 core/skills/gh-backlog-reader/scripts/read_backlog.py --assignee ccamacho --detail

# All issues (open + closed) as JSON
python3 core/skills/gh-backlog-reader/scripts/read_backlog.py --state all --json
```
